...
export const equipment = { // TEMPLATE: "": new equipmentData({ name: "", type: "", pips: [], innate: {}, requirements: {} }),
    ...
    "Assassin's Hood": new equipmentData({ name: "Assassin's Hood", type: "head", pips: ["rare", "rare"], innate: {"Deep Wound": "Assasinating a target applies anti-heal for 20s and gives you a speed boost for 3s. Assasination damage now scales with level against mobs.", "stealth": 5}, requirements: {"power": 6, "agility": 10}, rarity: "rare" }),
    ...
    "Blackleaf Helm": new equipmentData({ name: "Blackleaf Helm", type: "head", pips: ["rare", "rare"], innate: {"health": 5, "posture": 1, "Concussive Force": "Enemies you knocked remain downed longer than usual."}, requirements: {"fortitude": 20}, rarity: "rare" }),
    "Blacksteel Helm": new equipmentData({ name: "Blacksteel Helm", type: "head", pips: ["uncommon", "rare"], innate: {"health": 10}, requirements: {"power": 8, "fortitude": 10}, rarity: "rare" }),
    ...
    "Bloodforged Crown": new equipmentData({ name: "Bloodforged Crown", type: "head", pips: ["rare", "legendary"], innate: {"health": 5, "Cauterized Wounds": "Blood loss from all sources is lowered."}, requirements: {"power": 10}, rarity: "mythic" }),
    ...
    "Bulwark Helm": new equipmentData({ name: "Bulwark Helm", type: "head", pips: ["rare", "legendary"], innate: {"health": 3, "Strong Hold": "When above half health and two-handing, posture damage taken is reduced by 20%."}, requirements: {"power": 8}, rarity: "rare" }),
    ...
    "Chef's Toque": new equipmentData({ name: "Chef's Toque", type: "head", pips: ["legendary"], innate: {"health": 10, "Umami": "UNKNOWN", "Gourmand": "Your hunger and thirst gain from eating is increased."}, requirements: {"power": 8}, rarity: "unique" }), // MISSING TALENT DESCRIPTION
    ...
    "Deepwoken Hood": new equipmentData({ name: "Deepwoken Hood", type: "head", pips: ["rare", "rare", "legendary"], innate: {}, requirements: {"power": 6, "agility": 10}, rarity: "rare" }),
    ...
    "Familiar Heretic's Helm": new equipmentData({ name: "Familiar Heretic's Helm", type: "head", pips: ["uncommon", "rare"], innate: {"health": 10}, requirements: {"power": 8}, rarity: "hallowtide" }),
    "Familiar Knight's Helm": new equipmentData({ name: "Familiar Knight's Helm", type: "head", pips: ["uncommon", "rare"], innate: {"health": 10}, requirements: {"power": 8}, rarity: "hallowtide" }),
    "Familiar Priest's Helm": new equipmentData({ name: "Familiar Priest's Helm", type: "head", pips: ["uncommon", "rare"], innate: {"health": 10}, requirements: {"power": 8}, rarity: "hallowtide" }),
    "Feathertop Helm": new equipmentData({ name: "Feathertop Helm", type: "head", pips: ["uncommon"], innate: {"health": 3}, requirements: {}, rarity: "rare" }),
    "Gladiator Helmet": new equipmentData({ name: "Gladiator Helmet", type: "head", pips: ["rare"], innate: {"health": 5, "posture": 2, "Concussive Force": "Enemies you knocked remain downed longer than usual."}, requirements: {"power": 8, "fortitude": 15}, rarity: "uncommon" }),
    ...
    "Grand Fisher Helm": new equipmentData({ name: "Grand Fisher Helm", type: "head", pips: ["rare", "legendary"], innate: {"health": 5, "frost": 5, "thunder": 5, "Coldseep Reactor": "By cultivating the localized chemosynthetic microorganisms within the Depths and utilizing them as a power source, your helm thrums with a protective field of static electricity and heat."}, requirements: {"power": 13}, rarity: "unique" }),
    "Guard's Kabuto": new equipmentData({ name: "Guard's Kabuto", type: "head", pips: ["rare"], innate: {"health": 8}, requirements: {"power": 5}, rarity: "rare" }),
    ...
    "Immortal Helm": new equipmentData({ name: "Immortal Helm", type: "head", pips: ["rare", "legendary"], innate: {"health": 5, "Immortality": "UNKNOWN"}, requirements: {"power": 5}, rarity: "legendary" }), // MISSING TALENT DESCRIPTION
    ...
    "Knight's Helm": new equipmentData({ name: "Knight's Helm", type: "head", pips: ["uncommon", "rare"], innate: {"health": 10}, requirements: {"power": 8, "fortitude": 10}, rarity: "rare" }),
    ...
    "Phalanx Helmet": new equipmentData({ name: "Phalanx Helmet", type: "head", pips: ["rare", "legendary"], innate: {"health": 3, "Precise Swing": "After landing a critical your next light attack will gain 5% chip past your opponent's block."}, requirements: {"power": 8}, rarity: "rare" }),
    "Pumpkin Head": new equipmentData({ name: "Pumpkin Head", type: "head", pips: [], innate: {}, requirements: {}, rarity: "hallowtide" }),
    "Royal Guard's Kabuto": new equipmentData({ name: "Royal Guard's Kabuto", type: "head", pips: ["rare", "legendary"], innate: {"health": 8}, requirements: {"power": 10}, rarity: "rare" }),
    "Simmerbloom Diadem": new equipmentData({ name: "Simmerbloom Diadem", type: "head", pips: ["rare", "legendary"], innate: {"health": 5, "Simmerbloom": "UNKNOWN"}, requirements: {"power": 10}, rarity: "unique" }), // MISSING TALENT DESCRIPTION
    "Smith's Bandana": new equipmentData({ name: "Smith's Bandana", type: "head", pips: ["uncommon"], innate: {"health": 4}, requirements: {}, rarity: "rare" }),
    "Ten Gallon Hat": new equipmentData({ name: "Ten Gallon Hat", type: "head", pips: ["rare"], innate: {"posture": 2, "Give and Take": "Deal less damage to comrades and receive less damage from comrades."}, requirements: {"power": 5}, rarity: "rare" }),
    ...
    "Deepscorn Casque": new equipmentData({ name: "Deepscorn Casque", type: "head", pips: ["rare", "legendary"], innate: {"health": 5, "Already Dead": "You take reduced damage from abilities with a health cost."}, requirements: {"power": 6, "agility": 10}, rarity: "unique" }),
    // #endregion
    // #region ARMS EQUIPMENT
    "Adjudicator's Coat": new equipmentData({ name: "Adjudicator's Coat", type: "arms", pips: ["rare", "rare"], innate: {"Unwavering Resolve": "Getting parried punishes your posture 33% less."}, requirements: {"power": 8}, rarity: "rare" }),
    "Adventurer Coat": new equipmentData({ name: "Adventurer Coat", type: "arms", pips: ["rare", "rare"], innate: {"health": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Aristocrat Coat": new equipmentData({ name: "Aristocrat Coat", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"Art of the Deal": "Your rapport with merchants gives you lower prices!"}, requirements: {"power": 10}, rarity: "uncommon" }),
    ...
    "Azure Royal Guard": new equipmentData({ name: "Azure Royal Guard", type: "arms", pips: ["rare", "rare"], innate: {}, requirements: {"level": 8}, rarity: "common" }),
    "Black Overcoat": new equipmentData({ name: "Black Overcoat", type: "arms", pips: ["uncommon", "rare"], innate: {"health": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Black Parka": new equipmentData({ name: "Black Parka", type: "arms", pips: ["rare"], innate: {"health": 2, "posture": 1, "Steady Footing": "You're much more resistant to being pushed around."}, requirements: {"level": 5}, rarity: "rare" }),
    "Blacksteel Pauldrons": new equipmentData({ name: "Blacksteel Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "posture": 1}, requirements: {"level": 8}, rarity: "rare" }),
    "Bluesteel Pauldrons": new equipmentData({ name: "Bluesteel Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 5}, requirements: {"level": 5}, rarity: "rare" }),
    "Brigand's Cloak": new equipmentData({ name: "Brigand's Cloak", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "stealth": 4}, requirements: {"level": 5}, rarity: "rare"}),
    "Brilliant Pauldrons": new equipmentData({ name: "Brilliant Pauldrons", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"health": 5}, requirements: {"level": 10}, rarity: "common" }),
    "Brown Overcoat": new equipmentData({ name: "Brown Overcoat", type: "arms", pips: [], innate: {"health": 2, "posture": 1}, requirements: {}, rarity: "rare" }),
    "Brown Parka": new equipmentData({ name: "Brown Parka", type: "arms", pips: ["rare"], innate: {"health": 2, "posture": 1, "Steady Footing": "You're much more resistant to being pushed around."}, requirements: {"level": 5}, rarity: "rare" }),
    ...
    "Deepwoken Cloak": new equipmentData({ name: "Deepwoken Cloak", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"Blade Dancer": "Landing an M1 removes your roll cooldown."}, requirements: {"power": 10}, rarity: "legendary" }),
    ...
    "Diver's Light Plate": new equipmentData({ name: "Diver's Light Plate", type: "arms", pips: ["legendary", "legendary", "legendary"], innate: {"health": 10, "posture": 1, "Conquer your Fears": "Killing the beings of the deep replenishes your sanity somewhat. When an Ally grips an enemy nearby to you, you regain Sanity."}, requirements: {"power": 13, "fortitude": 5}, rarity: "mythic" }),
    "Enforcer Plate": new equipmentData({ name: "Enforcer Plate", type: "arms", pips: ["rare", "legendary"], innate: {"posture": 1, "Berserker": "Knocking an enemy grants you 20% damage resistance for 15 seconds."}, requirements: {"level": 8}, rarity: "uncommon" }),
    ...
    "First Ranger Duster": new equipmentData({ name: "First Ranger Duster", type: "arms", pips: ["rare", "rare"], innate: {"health": 10, "posture": 2}, requirements: {"power": 10}, rarity: "rare" }),
    "Flameguard Pauldrons": new equipmentData({ name: "Flameguard Pauldrons", type: "arms", pips: ["rare"], innate: {}, requirements: {}, rarity: "common" }),
    "Fur Pauldrons": new equipmentData({ name: "Fur Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 3}, requirements: {"level": 5}, rarity: "rare" }),
    ...
    "Glassdancer Wraps": new equipmentData({ name: "Glassdancer Wraps", type: "arms", pips: ["rare"], innate: {"health": 2, "posture": 3, "Lightweight": "Move faster when your armor runs out of durability."}, requirements: {"power": 8}, rarity: "rare" }),
    ...
    "Grand Fisher Plate": new equipmentData({ name: "Grand Fisher Plate", type: "arms", pips: ["legendary", "legendary", "legendary"], innate: {"health": 10, "posture": 1, "Diver's Resilience": "You can parry unparryable attacks from giant monsters, but due to the heft of your plate you have slightly reduced speed."}, requirements: {"power": 13}, rarity: "unique" }),
    "Grand Pauldrons": new equipmentData({ name: "Grand Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"posture": 1}, requirements: {"level": 5}, rarity: "common" }),
    ...
    "Hive Scourge Curiass": new equipmentData({ name: "Hive Scourge Curiass", type: "arms", pips: ["uncommon", "rare", "legendary"], innate: {"health": 5, "posture": 2, "Lowstride": "Speed during crouching increased, unsheathing a weapon is silent and stealth increased."}, requirements: {"power": 13}, rarity: "rare" }),
    "Ignition Gauntlets": new equipmentData({ name: "Ignition Gauntlets", type: "arms", pips: ["rare", "legendary", "legendary"], innate: {"health": 8, "posture": 1}, requirements: {"power": 13}, rarity: "legendary" }),
    "Imperial Pauldrons": new equipmentData({ name: "Imperial Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 7, "posture": 1}, requirements: {"power": 8}, rarity: "rare" }),
    "Iron Pauldrons": new equipmentData({ name: "Iron Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {}, requirements: {"level": 5}, rarity: "rare" }),
    "Ironsinger Heavy Plate": new equipmentData({ name: "Ironsinger Heavy Plate", type: "arms", pips: ["rare", "legendary", "legendary"], innate: {"health": 10, "ironsing": 5, "Defiant until the End": "Slow the enemy trying to execute you down with one last shout of your determination."}, requirements: {"power": 13, "fortitude": 15}, rarity: "legendary" }),
    "Justicar Defender": new equipmentData({ name: "Justicar Defender", type: "arms", pips: ["rare", "rare"], innate: {}, requirements: {"power": 8}, rarity: "uncommon" }),
    "Khan Pauldrons": new equipmentData({ name: "Khan Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "Polite Awakening": "Recover 15% of your max health after getting up from being downed."}, requirements: {"level": 8}, rarity: "rare" }),
    "Leather Gloves": new equipmentData({ name: "Leather Gloves", type: "arms", pips: ["common"], innate: {"health": 2, "posture": 1}, requirements: {}, rarity: "common" }),
    "Leather Pauldrons": new equipmentData({ name: "Leather Pauldrons", type: "arms", pips: [], innate: {"health": 5, "posture": 1}, requirements: {}, rarity: "common" }),
    "Legion Phalanx Plate": new equipmentData({ name: "Legion Phalanx Plate", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"health": 6, "posture": 2, "Hoplite": "Posture damage is reduced by 30% when wielding a spear and standing still."}, requirements: {"power": 13}, rarity: "rare" }),
    ...
    "Mercenary's Garb": new equipmentData({ name: "Mercenary's Garb", type: "arms", pips: ["rare", "legendary"], innate: {"stealth": 6, "Kick Off": "You easily brush off shorter falls, taking no damage. Your first wall jump will always send you higher than normal. Gain a speed boost after wall jumping over a wall."}, requirements: {"level": 5}, rarity: "rare" }),
    "Ministry Cloak": new equipmentData({ name: "Ministry Cloak", type: "arms", pips: ["rare", "legendary"], innate: {"health": 5, "ether": 10}, requirements: {"power": 8}, rarity: "rare" }),
    "Ministry Operative Cloak": new equipmentData({ name: "Ministry Operative Cloak", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"stealth": 6, "Ether Conduit": "Your Ether Adept Talents that grant you ether on proc now give you stacks of Inspiration. At 3 stacks of Inspiration. your mantras will deal 10% more damage for 3s."}, requirements: {"level": 8}, rarity: "rare" }),
    "Monastery Champion Robes": new equipmentData({ name: "Monastery Champion Robes", type: "arms", pips: ["rare", "legendary", "legendary"], innate: {"health": 8, "posture": 1, "Temple Guard": "For the first 0.3s of your Critical Attack's windup, you take 90% less damage from any attacks that cancel your windup."}, requirements: {}, rarity: "legendary" }),
    "Moonseye Gauntlets": new equipmentData({ name: "Moonseye Gauntlets", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"health": 7, "posture": 3}, requirements: {"power": 13}, rarity: "legendary" }),
    "Novice Brace": new equipmentData({ name: "Novice Brace", type: "arms", pips: ["rare"], innate: {"health": 2, "posture": 1}, requirements: {"level": 5}, rarity: "rare" }),
    "Pathfinder Elite": new equipmentData({ name: "Pathfinder Elite", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"dvm": 5}, requirements: {"power": 8}, rarity: "rare" }),
    "Providence Coat": new equipmentData({ name: "Providence Coat", type: "arms", pips: ["rare", "rare", "legendary"], innate: {"health": 5, "Braced Collapse": "After being block broken, the next attack to hit you deals reduced damage."}, requirements: {"power": 10}, rarity: "legendary" }),
    "Ranger's Brace": new equipmentData({ name: "Ranger's Brace", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "posture": 1}, requirements: {"level": 8}, rarity: "uncommon" }),
    "Redsteel Pauldrons": new equipmentData({ name: "Redsteel Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "posture": 1}, requirements: {"level": 8}, rarity: "rare" }),
    "Royal Duelist": new equipmentData({ name: "Royal Duelist", type: "arms", pips: ["rare", "rare"], innate: {}, requirements: {"power": 8}, rarity: "uncommon" }),
    ...
    "Sandrunner Wraps": new equipmentData({ name: "Sandrunner Wraps", type: "arms", pips: ["rare", "legendary"], innate: {"health": 6, "stealth": 4, "flame": 8, "Kick Off": "You easily brush off shorter falls, taking no damage. Your first wall jump will always send you higher than normal. Gain a speed boost after wall jumping over a wall."}, requirements: {"level": 8}, rarity: "rare" }),
    "Silver Pauldrons": new equipmentData({ name: "Silver Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "posture": 1}, requirements: {"level": 8}, rarity: "rare" }),
    "Simple Pauldrons": new equipmentData({ name: "Simple Pauldrons", type: "arms", pips: ["common"], innate: {"health": 2, "posture": 1}, requirements: {}, rarity: "common" }),
    ...
    "Steel Pauldrons": new equipmentData({ name: "Steel Pauldrons", type: "arms", pips: ["uncommon"], innate: {"health": 5, "posture": 1}, requirements: {"level": 5}, rarity: "uncommon" }),
    "Tracker's Brace": new equipmentData({ name: "Tracker's Brace", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "posture": 1}, requirements: {"level": 8}, rarity: "rare" }),
    "Vanguard Brace": new equipmentData({ name: "Vanguard Brace", type: "arms", pips: ["rare", "rare"], innate: {"health": 3, "posture": 1, "Replenishing Knockout": "You gain more health and posture from downing enemies."}, requirements: {"level": 10}, rarity: "rare" }),
    "Warden Pauldrons": new equipmentData({ name: "Warden Pauldrons", type: "arms", pips: ["legendary", "legendary"], innate: {"health": 10, "posture": 2}, requirements: {"power": 13}, rarity: "legendary" }),
    "White Overcoat": new equipmentData({ name: "White Overcoat", type: "arms", pips: ["uncommon"], innate: {"health": 2}, requirements: {}, rarity: "rare" }),
    "White Parka": new equipmentData({ name: "White Parka", type: "arms", pips: ["uncommon", "rare"], innate: {"health": 2, "Steady Footing": "You're much more resistant to being pushed around."}, requirements: {"level": 5}, rarity: "rare" }),
    "Winter Corps Parka": new equipmentData({ name: "Winter Corps Parka", type: "arms", pips: ["rare", "rare"], innate: {"health": 6, "posture": 2, "frost": 5, "gale": 5, "Winter's Protection": "Your tightly-bound winter gear negates elemental damage buffs from weather on damage against you."}, requirements: {"level": 10}, rarity: "rare" }),
    "Woodland Pauldrons": new equipmentData({ name: "Woodland Pauldrons", type: "arms", pips: ["rare", "rare"], innate: {"health": 3}, requirements: {"level": 8}, rarity: "rare" }),
    // #endregion
    // #region LEGS EQUIPMENT
    "Autumn Boots": new equipmentData({ name: "Autumn Boots", type: "legs", pips: ["rare", "rare"], innate: {"health": 2}, requirements: {}, rarity: "rare" }),
    "Azure Royal Guard Boots": new equipmentData({ name: "Azure Royal Guard Boots", type: "legs", pips: ["rare", "rare", "legendary"], innate: {}, requirements: {}, rarity: "rare" }),
    ...
    "Mercenary's Boots": new equipmentData({ name: "Mercenary's Boots", type: "legs", pips: ["rare", "rare", "legendary"], innate: {"health": 2, "Endurance Runner": "Even when things look dire, you still have it in you to keep your legs moving."}, requirements: {"level":10}, rarity: "rare" }),
    ...
    "Black Cape": new equipmentData({ name: "Black Cape", type: "torso", pips: ["legendary"], innate: {"physical": 3}, requirements: {"level": 5}, rarity: "uncommon" }),
    "Brilliant Cape": new equipmentData({ name: "Brilliant Cape", type: "torso", pips: ["legendary"], innate: {"elemental": 3}, requirements: {"level": 5}, rarity: "uncommon" }),
    "Canticlysm Pendant": new equipmentData({ name: "Canticlysm Pendant", type: "torso", pips: ["rare", "legendary"], innate: {"elemental": 3}, requirements: {"level": 8}, rarity: "rare" }),
    "Confessor's Charm": new equipmentData({ name: "Confessor's Charm", type: "torso", pips: ["rare", "legendary"], innate: {"physical": 3}, requirements: {"level": 8}, rarity: "rare" }),
    "Curseblood Pendant": new equipmentData({ name: "Curseblood Pendant", type: "torso", pips: ["legendary"], innate: {"elemental": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Dark Owl Cape": new equipmentData({ name: "Dark Owl Cape", type: "torso", pips: ["legendary"], innate: {"stealth": 6, "shadow": 5, "elemental": 2}, requirements: {"level": 5}, rarity: "rare" }),
    "Fleet Warden Cape": new equipmentData({ name: "Fleet Warden Cape", type: "torso", pips: ["rare", "legendary"], innate: {"elemental": 3}, requirements: {"power": 8}, rarity: "uncommon" }),
    "Golden Cape": new equipmentData({ name: "Golden Cape", type: "torso", pips: ["legendary"], innate: {"physical": 3}, requirements: {"level": 5}, rarity: "uncommon" }),
    "Grand Pathfinder's Backpack": new equipmentData({ name: "Grand Pathfinder's Backpack", type: "torso", pips: ["rare", "rare"], innate: {"carry": 50, "Robber Baron": "You hold onto more items when defeated."}, requirements: {"level": 8}, rarity: "rare" }),
    "Monastery Champion Beads": new equipmentData({ name: "Monastery Champion Beads", type: "torso", pips: ["legendary"], innate: {"elemental": 3}, requirements: {"level": 5}, rarity: "legendary" }),
    "Nomad Pendant": new equipmentData({ name: "Nomad Pendant", type: "torso", pips: ["legendary"], innate: {"elemental": 3}, requirements: {"level": 5}, rarity: "rare" }),
    ...
    "Red Eye Pendant": new equipmentData({ name: "Red Eye Pendant", type: "torso", pips: ["legendary"], innate: {"elemental": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Sandrunner Scarf": new equipmentData({ name: "Sandrunner Scarf", type: "torso", pips: ["rare", "legendary"], innate: {"flame": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Scarf": new equipmentData({ name: "Scarf", type: "torso", pips: ["rare", "legendary"], innate: {"elemental": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Seafarer Pendant": new equipmentData({ name: "Seafarer Pendant", type: "torso", pips: ["legendary"], innate: {}, requirements: {"level": 5}, rarity: "rare" }),
    "Shrouded Cape": new equipmentData({ name: "Shrouded Cape", type: "torso", pips: ["rare", "legendary"], innate: {"stealth": 5, "elemental": 2}, requirements: {"level": 5}, rarity: "rare" }),
    "Varicosa Medallion": new equipmentData({ name: "Varicosa Medallion", type: "torso", pips: ["rare", "legendary"], innate: {"shadow": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Whaler Scarf": new equipmentData({ name: "Whaler Scarf", type: "torso", pips: ["legendary"], innate: {"elemental": 3}, requirements: {"level": 5}, rarity: "rare" }),
    "Wormwarder Lantern": new equipmentData({ name: "Wormwarder Lantern", type: "torso", pips: [], innate: {"carry": 10, "sanity": 10}, requirements: {}, rarity: "rare" }),
    "Lightkeeper's Medallion": new equipmentData({ name: "Lightkeeper's Medallion", type: "torso", pips: ["legendary"], innate: {"Elegy of Light": "UNKNOWN"}, requirements: {"level": 8}, rarity: "relic" }), // MISSING TALENT DESCRIPTION
    "Tiran Pendant": new equipmentData({ name: "Tiran Pendant", type: "torso", pips: ["legendary"], innate: {"Featherfall": "UNKNOWN"}, requirements: {"level": 8}, rarity: "relic" }), // MISSING TALENT DESCRIPTION
    "Warmaster's Medallion": new equipmentData({ name: "Warmaster's Medallion", type: "torso", pips: ["legendary"], innate: {"Actions Speak Louder": "Your Critical Attack cooldown is 20% shorter, but your Resonance cooldown is double as long. In areas where your Resonance is suppressed, reduces your cooldown by 5% instead."}, requirements: {"level": 8}, rarity: "relic" }),
    "Whistling Periapt": new equipmentData({ name: "Whistling Periapt", type: "torso", pips: [], innate: {"health": 1, "wind": 8, "Whistleguard": "Upon inflicting continuous damage onto an enemy without getting parried or dodged, a whirling ball of wind coats your character. When hit, the shield parries any attack for free and dissolves into the air after. Shields cannot stack."}, requirements: {"level": 8}, rarity: "relic" }),
    // #endregion
    ...
    "Moonlit Earrings": new equipmentData({ name: "Moonlit Earrings", type: "ears", pips: ["rare", "rare"], innate: {"health": 2}, requirements: {"level": 5}, rarity: "rare" }),
    "Old Blood Earrings": new equipmentData({ name: "Old Blood Earrings", type: "ears", pips: ["rare", "rare"], innate: {"ether": 5}, requirements: {"level": 5}, rarity: "rare" }),
    ...
    "Ferryman's Ring": new equipmentData({ name: "Ferryman's Ring", type: "rings", pips: ["legendary"], innate: {}, requirements: {"power": 6}, rarity: "legendary" }),
    "Finisher's Ring": new equipmentData({ name: "Finisher's Ring", type: "rings", pips: [], innate: {}, requirements: {"power": 10}, rarity: "legendary" }),
    ...
    "Ring of Casters": new equipmentData({ name: "Ring of Casters", type: "rings", pips: [], innate: {}, requirements: {"power": 10}, rarity: "rare" }),
...
export function getHighestPipValue(passedPips, type, pip, checkForSameType) {
    ...
    passedPips.forEach(pipRarity => {
        ...
        if (pipValue !== 0) {
            ...
            const randomPip = getRandomPip(type, pipRarity)
            if (randomPip) {
                rolledPips.push(randomPip);
            }
        }
    })
    if (checkForSameType && rolledPips.length > 0) {
        let lowestPriorityPip = rolledPips.reduce((prev, current) => ((prev ? pipPriority[prev.rarity] : -1) < (current ? pipPriority[current.rarity] : -2)) ? prev : current);
