...
export const equipment = { // TEMPLATE: "": new equipmentData({ name: "", type: "", pips: [], innate: {}, requirements: {} }),
    ...
    "Monastery Champion Robes": new equipmentData({ name: "Monastery Champion Robes", type: "arms", pips: ["rare", "legendary", "legendary"], innate: {"health": 8, "Temple Guard": "For the first 0.3s of your Critical Attack's windup, you take 90% less damage from any attacks that cancel your windup."}, requirements: {}, rarity: "legendary" }),
