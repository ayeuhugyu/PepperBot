...
async function listCommands(message, gconfig) {
    ...
    embed.setDescription(`for a more detailed commands list, visit [the guide page](https://pepperbot.online/guide) \nrun ${prefix}help [command] for more info about that specific command`);
    let fieldsText = {
        [1]: "",
        [2]: "",
        [3]: "",
...
async function infoAboutCommand(
    ...
    let text = `visit [the guide page](https://pepperbot.online/guide?command=${command.name}) for more detailed information\n${command.description}\n`;
